...
/**
 * "Alt+P" / "Shift+Ctrl+X" -> a chord. Anything else -> a sequence of plain,
 * unmodified keys typed one after another (case-insensitive — see the
 * settings tab help text for why sequences don't try to track Shift).
 *
